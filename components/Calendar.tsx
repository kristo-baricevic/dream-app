  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: 'w-9 font-medium text-sm sm:text-xs text-center text-gray-400 pb-2',
        row: 'w-full mt-0.5',
        ...
        day_selected: cx('rounded-sm', 'aria-selected:bg-blue-500 aria-selected:text-white'),
